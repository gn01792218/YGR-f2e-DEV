<template>
  <div class="w-[80%] max-w-[433px] mx-auto mt-10">
    <div class="w-full mb-10">
      <img
        class="w-full"
        src="../assets/images/YGR_logo.png"
        alt="YGR官網LOGO"
      />
    </div>
    <select
      class="w-full rounded-lg p-1 mb-1 md:mb-5"
      name=""
      id=""
      v-model="env"
    ...
    <div class="w-full flex flex-col">
      ...
      <button
        v-else
        class="w-full border-4 primary-btn"
        @click="loginRequest(userNameInput, env)"
      >
        登入
      </button>
    </div>
