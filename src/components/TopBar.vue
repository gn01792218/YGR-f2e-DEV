<template>
  <div class="flex justify-between items-start md:items-center">
    ...
    <div class="md:w-[35%] flex justify-end items-start">
      <div class="flex flex-col">
        <div class="text-white text-center mb-1 md:mb-5">DEV環境</div>
        <select class="w-full rounded-lg p-1 mb-1 md:mb-5" name="" id="" v-model="currentLang" @change="selectLang(currentLang)">
